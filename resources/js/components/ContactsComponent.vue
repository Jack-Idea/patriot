<template>
    <div class="flex flex-col lg:flex-row justify-between lg:mt-10 relative">
        <div class="bg-[var(--accent-color)] w-[75%] h-1/4 absolute top-[39%] rounded-lg hidden lg:flex"></div>
        <div class="w-full lg:w-[45%] flex flex-col">
            ...
            <div class="flex flex-col lg:flex-row justify-between lg:mt-auto">
                <div class="flex items-center lg:flex-col mt-5 lg:mt-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--accent-color)" class="w-10 h-10 lg:w-14 lg:h-14">
        ...
        <div class="w-full lg:w-1/2 relative mt-20 lg:mt-0">
            <div class="absolute top-[-50px] -right-10 lg:right-[70px] bg-[var(--accent-color)] w-1/3 h-3/4 rounded-lg"></div>
